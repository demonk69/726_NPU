...
def main(args):
    ...
    model = build_model(num_classes=10, width_mult=args.width_mult).to(device)
...
def parse_args():
    parser = argparse.ArgumentParser(description="Train INT8-friendly RepOpt-VGG-style CNN on CIFAR-10")
    parser.add_argument("--data_root", type=str, default="./data")
    parser.add_argument("--save_dir", type=str, default="./runs/cifar10_repopt_vgglike_fp32")
