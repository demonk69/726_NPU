// Auto-generated for N=8 (COLS=1, K=8), 4 tests
`define NUM_TESTS 4
`define DRAM_SIZE 17097
...
`define T0_EXPECTED 32'h0000093b
`define T0_IS_FP16  0
`define T0_IS_OS    0
...
`define T1_EXPECTED 32'h000016f0
`define T1_IS_FP16  0
`define T1_IS_OS    1
...
`define T2_EXPECTED 32'hbfc80000
`define T2_IS_FP16  1
`define T2_IS_OS    0
...
`define T3_EXPECTED 32'hbf000000
`define T3_IS_FP16  1
`define T3_IS_OS    1
