...
def get_transforms(img_size=224):
    """
    这里将 CIFAR-10 的 32x32 图像 resize 到 224x224，
    以便更自然地适配 ImageNet 预训练的 ResNet18。
    """
...
def build_dataloaders(
    ...
    train_tf, test_tf = get_transforms(img_size=img_size)
...
def main(args):
    ...
    if args.resume and latest_ckpt.exists():
        ...
        print(f"Resume start_epoch={start_epoch}, best_val_acc={best_val_acc:.2f}")
...
def parse_args():
    parser = argparse.ArgumentParser(description="CIFAR-10 Training with ResNet18")
    parser.add_argument("--data_root", type=str, default="./data")
    parser.add_argument("--save_dir", type=str, default="./runs/cifar10_resnet18")
