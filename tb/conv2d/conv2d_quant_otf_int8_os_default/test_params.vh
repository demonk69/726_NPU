// Auto-generated: conv2d_quant_otf_int8_os_default (int8 OS)
...
`define R_ADDR 32'h00010270
`define BIAS_ADDR 32'h0001049c
`define BIAS_EN 1
`define ACT_MODE 1
`define QUANT_EN 1
`define QUANT_CFG 32'h00020303
`define QUANT_SCALE 2
`define QUANT_SHIFT 3
`define QUANT_ROUND 1
`define CTRL   32'h711
`define DRAM_SIZE 16682
`define IS_FP16 0
`define IS_OS   1
`define CONV_BATCH 1
`define CONV_IH 5
