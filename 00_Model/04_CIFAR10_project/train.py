...
def build_dataloaders(data_root="./data", batch_size=128, num_workers=4, val_ratio=0.1):
    ...
    train_subset, val_subset = random_split(range(total_len), [train_len, val_len], generator=generator)
...
def parse_args():
    parser = argparse.ArgumentParser(description="Train CIFAR-style ResNet18 on CIFAR-10")
    parser.add_argument("--data_root", type=str, default="./data")
    parser.add_argument("--save_dir", type=str, default="./runs/cifar10_resnet18_cifar")
