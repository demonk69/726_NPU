// =============================================================================
// Auto-generated testbench wrapper for N=8
...
initial begin
    for (dram_i = 0; dram_i < DRAM_SZ; dram_i = dram_i + 1)
        dram[dram_i] = 32'h0;
    $readmemh("D:/NPU_prj/tb/array_scale/N8/dram_init.hex", dram);
end
...
initial begin
    ...
    $readmemh("D:/NPU_prj/tb/array_scale/N8/expected.hex", expected);
end
