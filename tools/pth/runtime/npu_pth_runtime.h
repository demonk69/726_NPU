...
#define NPU_PTH_REG_PERF_CYCLES      0x48u
#define NPU_PTH_REG_PERF_RD_BEATS    0x4cu
#define NPU_PTH_REG_PERF_WR_BEATS    0x50u
#define NPU_PTH_REG_PERF_RD_BYTES    0x54u
#define NPU_PTH_REG_PERF_WR_BYTES    0x58u
#define NPU_PTH_REG_PERF_RD_BURSTS   0x6cu
#define NPU_PTH_REG_PERF_WR_BURSTS   0x70u
#define NPU_PTH_REG_PERF_CTRL        0x78u
...
#define NPU_PTH_REG_PERF_MAC_OPS_LO  0xa0u
#define NPU_PTH_REG_PERF_MAC_OPS_HI  0xa4u
#define NPU_PTH_REG_PERF_OPS_LO      0xa8u
#define NPU_PTH_REG_PERF_OPS_HI      0xacu
#define NPU_PTH_REG_PERF_BUSY_CYCLES 0xb0u
#define NPU_PTH_REG_PERF_COMPUTE_CYCLES 0xb4u
#define NPU_PTH_REG_PERF_DMA_CYCLES  0xb8u
#define NPU_PTH_REG_PERF_PEAK_OPS_CYCLE 0xc8u

#define NPU_PTH_STATUS_BUSY          0x00000001u
#define NPU_PTH_STATUS_DONE          0x00000002u
#define NPU_PTH_STATUS_ERROR         0x00000004u

#define NPU_PTH_PERF_CTRL_CLEAR      0x00000001u
#define NPU_PTH_PERF_CTRL_SNAPSHOT   0x00000002u
