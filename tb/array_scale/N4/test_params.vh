// Auto-generated for N=4 (COLS=1, K=4), 4 tests
`define NUM_TESTS 4
`define DRAM_SIZE 17093
...
`define T0_EXPECTED 32'h00001245
`define T0_IS_FP16  0
`define T0_IS_OS    0
...
`define T1_EXPECTED 32'h00000cd5
`define T1_IS_FP16  0
`define T1_IS_OS    1
...
`define T2_EXPECTED 32'hc0000000
`define T2_IS_FP16  1
`define T2_IS_OS    0
...
`define T3_EXPECTED 32'h3f400000
`define T3_IS_FP16  1
`define T3_IS_OS    1
