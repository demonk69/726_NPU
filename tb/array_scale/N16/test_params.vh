// Auto-generated for N=16 (COLS=1, K=16), 4 tests
`define NUM_TESTS 4
`define DRAM_SIZE 17105
...
`define T0_EXPECTED 32'h00001a4e
`define T0_IS_FP16  0
`define T0_IS_OS    0
...
`define T1_EXPECTED 32'hfffffe43
`define T1_IS_FP16  0
`define T1_IS_OS    1
...
`define T2_EXPECTED 32'h40a00000
`define T2_IS_FP16  1
`define T2_IS_OS    0
...
`define T3_EXPECTED 32'hbf800000
`define T3_IS_FP16  1
`define T3_IS_OS    1
